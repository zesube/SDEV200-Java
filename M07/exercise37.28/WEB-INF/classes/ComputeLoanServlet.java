...
@WebServlet("/ComputeLoanServlet")                // <-- map the servlet
public class ComputeLoanServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p><strong>Monthly Payment: $"
                    + money.format(loan.getMonthlyPayment()) + "</strong></p>");
            out.println("<p><strong>Total Payment: $"
                    + money.format(loan.getTotalPayment()) + "</strong></p>");
